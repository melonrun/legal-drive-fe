  ...
  <section class="content">
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <link rel="stylesheet" href="/legal/static/js/plugins/jvectormap/jquery-jvectormap-2.0.3.css" >
      </div>
    </div>
  </section>
</template>
<script>
import {stats} from '../../demo1'

const pluginURL = '/legal/static/js/plugins/jvectormap/jquery-jvectormap-2.0.3.min.js'
const mapURL = '/legal/static/js/plugins/jvectormap/jquery-jvectormap-world-mill.js'
